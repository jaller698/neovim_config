return {
  ...
  opts = function(_, opts)
    ...
    opts.statusline = { -- statusline
      ...
      status.component.git_branch(), -- only updates on bufWrite
      ...
      status.component.nav {
        scrollbar = { hl = { fg = "fg" } }, -- Customize scrollbar color if desired
      },
      ...
      status.component.builder {
        {
          ...
          hl = function()
            return { bg = "bg", fg = status.hl.mode_bg() } -- highlight based on bg and fg}
          end,
        },
        ...
        surround = { separator = "right" }, -- background
      },
    }
